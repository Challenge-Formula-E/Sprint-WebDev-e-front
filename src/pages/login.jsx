  ...
  return (
    ...
    >
      ...
      <div className=" min-h-screen bg-cover flex items-center justify-center ">
        <div className="bg-white rounded-lg shadow-lg p-8 mx-8 max-w-md w-full md:max-w-lg">
          <h2 className=" Login-text text-xl font-bold text-center mb-4">
            LOGIN
          </h2>
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-4">
              ...
              <input type="email" id="email" {...register("email")} placeholder="Email@123.com" className="mt-1 block w-full text-black border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required />
            </div>
            <div className="mb-4">
              <label
                htmlFor="password"
                className="block text-sm font-medium text-gray-700">Password</label>
              <input type="password" id="password" {...register("password")} placeholder="Password123." className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-black" autoComplete="current-password" required />
            </div>
